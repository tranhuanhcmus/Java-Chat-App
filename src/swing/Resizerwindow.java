...
public class Resizerwindow extends MouseAdapter {
	 ...
	 */
	public Resizerwindow(Component... components) {
	 ...
	 * @param components components to be automatically registered
	 */
	public Resizerwindow(Insets dragInsets, Component... components) {
		this(dragInsets, new Dimension(1, 1), components);
	}

	/**
	 * Create a Resizerwindow.
	 *
	 * @param dragInsets Insets specifying which borders are eligible to be resized.
	 ...
	 * @param components components to be automatically registered
	 */
	public Resizerwindow(Insets dragInsets, Dimension snapSize, Component... components) {
